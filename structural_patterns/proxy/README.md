...
Provide a surrogate or placeholder for another object to control access to it. Class that will limit access to another class. Used for security reasons, because object ins intensive to create, or accessed from remote location.
